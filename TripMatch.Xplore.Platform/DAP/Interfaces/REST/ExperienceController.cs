...
namespace TripMatch.Xplore.Platform.DAP.Interfaces.REST;
...
/// </summary>
[ApiController]
[Route("api/v1/design/[controller]")]
    ...
    [FromQuery] decimal? budget = null)
{
    ...
    if (!string.IsNullOrWhiteSpace(experienceType))
    {
        ...
        {
            filteredExperiences = Enumerable.Empty<TripMatch.Xplore.Platform.DAP.Domain.Models.Entities.Experience>().AsQueryable();
        }
    }
